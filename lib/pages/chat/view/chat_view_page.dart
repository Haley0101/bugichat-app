                ...
                child: SingleChildScrollView(
                  child: SizedBox(
                    ...
                    child: Obx(() => controller.chatHistory.isEmpty ? Center(
                      child: Padding(
                        padding:
                        EdgeInsets.only(top: 180.h, right: 8.w, left: 8.w),
                        child: Text(
                          tr('chatBotHintText'),
                          style:
                          TextStyle(fontSize: 24.sp, color: ColorTheme.deepGrayText),
                      ...
                      children: List.generate(
                        controller.chatHistory.length,
                          ...
                          child: Padding(
                            ...
                            child: controller.chatHistory[i].type ==
                                ChatMessageType.MyMessage
                                ? Padding(
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(controller.chatHistory[i].content,
                                    style: TextStyle(
                                        fontSize: 28.sp,
                              ...
                              children: [
                                ...
                                Flexible(
                                  child: Container(
                                    margin: EdgeInsets.only(right: 62.w),
                                    padding: EdgeInsets.all(8.w),
                                    decoration: BoxDecoration(
              ...
              Padding(
                ...
                child: GlobalWidget().textField(
                    ...
                    suffixWidget: InkWell(
                        onTap: () async {
                          controller.chatHistory.add(ChatMessage(controller.userInputText.text, ChatMessageType.MyMessage));
